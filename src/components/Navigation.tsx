...
interface NavigationProps {
  activeTab: 'novo' | 'historico' | 'contos';                    // Aba ativa atual
  onTabChange: (tab: 'novo' | 'historico' | 'contos') => void;   // Callback para mudança de aba
}

/**
 * Componente Navigation - Barra de navegação principal
 * Permite alternar entre "Novo Split", "Histórico" e "Contos"
